...
export class SocialBlocks__getLastBidInfoByIdResult {
  value0: Address;
  value1: BigInt;
  value2: BigInt;
...
export class SocialBlocks__getPostInfoResultValue0Struct extends ethereum.Tuple {
  get buyStatus(): i32 {
    return this[0].toI32();
  }
...
export class SocialBlocks__userInfoResult {
  value0: string;
  value1: string;
  value2: string;
  value3: string;
...
export class SocialBlocks extends ethereum.SmartContract {
  static bind(address: Address): SocialBlocks {
    return new SocialBlocks("SocialBlocks", address);
  }
  ...
  getLastBidInfoById(_postId: BigInt): SocialBlocks__getLastBidInfoByIdResult {
    ...
    return new SocialBlocks__getLastBidInfoByIdResult(
      result[0].toAddress(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getLastBidInfoById(
    _postId: BigInt
  ): ethereum.CallResult<SocialBlocks__getLastBidInfoByIdResult> {
    let result = super.tryCall(
      "getLastBidInfoById",
      "getLastBidInfoById(uint256):(address,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(_postId)]
    ...
    return ethereum.CallResult.fromValue(
      new SocialBlocks__getLastBidInfoByIdResult(
        value[0].toAddress(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  getPostInfo(_postId: BigInt): SocialBlocks__getPostInfoResultValue0Struct {
    let result = super.call(
      "getPostInfo",
    ...
    return changetype<SocialBlocks__getPostInfoResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getPostInfo(
    _postId: BigInt
  ): ethereum.CallResult<SocialBlocks__getPostInfoResultValue0Struct> {
    let result = super.tryCall(
      "getPostInfo",
      "getPostInfo(uint256):((uint8,uint256,uint256,string))",
      [ethereum.Value.fromUnsignedBigInt(_postId)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<SocialBlocks__getPostInfoResultValue0Struct>(
        value[0].toTuple()
      )
    );
  }
  ...
  userInfo(param0: Address): SocialBlocks__userInfoResult {
    let result = super.call(
      "userInfo",
    ...
    return new SocialBlocks__userInfoResult(
      result[0].toString(),
      result[1].toString(),
      result[2].toString(),
      result[3].toString()
  ...
  try_userInfo(
    param0: Address
  ): ethereum.CallResult<SocialBlocks__userInfoResult> {
    let result = super.tryCall(
      "userInfo",
      "userInfo(address):(string,string,string,string)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new SocialBlocks__userInfoResult(
        value[0].toString(),
        value[1].toString(),
        value[2].toString(),
        value[3].toString()
  ...
  verify(
    ...
    let result = super.call(
      "verify",
      "verify(address,bytes,uint256,uint256):(bool)",
      [
        ethereum.Value.fromAddress(signer),
        ethereum.Value.fromBytes(signature),
        ethereum.Value.fromUnsignedBigInt(likesCount),
